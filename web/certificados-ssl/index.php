...
<head>
	...
	<!-- SEO página Home -->
	<title>ITedup | Certificados SSL</title>
			...
			<div class="fila">
				<div class="column-12 column-m-12" style="padding-right: 0; padding-left: 0;">
					<div class="headerPage__contenido">
						...
						<img class="imagen imagen-centrada headerPage__contenido--imagen" src="images/certificado-ssl.svg">
						<h1 class="molecula-titulo-principal color-secundario headerPage__contenido--titulo">Certificados SSL</h1>
						<h2 class="molecula-subtitulo color-secundarioA headerPage__contenido--subtitulo">Incrementa la seguridad de tu sitio y brinda a tus visitantes una conexión segura.</h2>
				  	...
				  	<div class="swiper-container1">
					    <div class="swiper-wrapper">
					      	<div class="swiper-slide">
						      	<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										<h3 class="s-paquetes__tarjeta-header--nombre color-primario">One-Product Básico</h3>
									...
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
											...
											<li style="font-weight: 300;margin-top: 15px;">Ideal para vender un solo producto</li>
										</ul>
									</div>
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$20,000</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$15,000</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
											<li>10 Secciones/Subsecciones</li>
											<li style="font-weight: 300;margin-top: 15px;">Ideal para cafes, restaurantes y bares</li>
										</ul>
									</div>
									<div class="tarjeta-footer s-paquetes__tarjeta-footer">
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$38,000</span>
									...
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
											<li>3 Páginas <br><span style="font-size: 12px; font-weight: 300;">(1 de Impacto, 2 Páginas)</span></li>
					      					...
					      					<li style="font-weight: 300; margin-top: 15px;">Ideal para pizzerías</li>
										</ul>
									</div>
									<div class="tarjeta-footer s-paquetes__tarjeta-footer">
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$62,000</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$50,000</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
											<li>10 Páginas <br><span style="font-size: 12px; font-weight: 300;">(3 de Impacto, 7 Páginas)</span></li>
					      					<li>ó hasta 50 secciones</li>
					      					<li style="font-weight: 300; margin-top: 15px;">Ideal para tiendas de ropa o calzado</li>
										</ul>
									</div>
									<div class="tarjeta-footer s-paquetes__tarjeta-footer">
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										<h3 class="s-paquetes__tarjeta-header--nombre color-primario">Internacional</h3>
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$140,000</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$120,000</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
											<li>30 Páginas <br><span style="font-size: 12px; font-weight: 300;">(5 de Impacto, 25 Páginas)</span></li>
					      					<li>ó hasta 100 secciones</li>
					      					<li style="font-weight: 300; margin-top: 15px;">Ideal para tiendas departamentales</li>
										</ul>
									</div>
									<div class="tarjeta-footer s-paquetes__tarjeta-footer">
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$240,000</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$200,000</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
											<li>50 Páginas <br><span style="font-size: 12px; font-weight: 300;">(10 de Impacto, 40 Páginas)</span></li>
					      					<li>ó hasta 150 secciones</li>
					      					<li style="font-weight: 300; margin-top: 15px;">Ideal para tiendas de retail</li>
										</ul>
									</div>
									<div class="tarjeta-footer s-paquetes__tarjeta-footer">
			...
			<div class="fila">
				<div class="column-12">
					<div class="tab-estilo2">
						...
						<button class="tablinks2" onclick="openTab2(event, 'Internacionalizacion')">Internacionalización</button>
  						<button class="tablinks2" onclick="openTab2(event, 'Extras')">Extras</button>
					</div>
					<div id="Incluido" class="tabcontent-estilo2">
					  	<div class="incluye">
							<p style="margin: 20px 0; font-weight: 400;">En todas las instalaciones de certificado SSL incluimos:</p>
							<ul>
								<li>Alta de cuenta con autoridad</li>
								<li>Configuración de dominio</li>
								<li>Redireccionamiento HTTPS a HTTPS</li>
								<li>Ajuste en registros DNS</li>
							</ul>
						</div>
					</div>
					<div id="Internacionalizacion" class="tabcontent-estilo2">
						...
						<div style="overflow-x: auto;">
							<table class="table" style="text-align: center;">
								<tbody>
								<tr>
									<th style="font-size: 18px; font-weight: 600; text-align: center;" colspan="2">Traducción</th>
								</tr>
								<tr>
									<td>6 a 9</td>
									<td>$500 c/u</td>
								...
								<tr>
									<th style="font-size: 18px; font-weight: 600; text-align: center;" colspan="2">Moneda</th>
								</tr>
								<tr>
									<td>--</td>
									<td>--</td>
								...
								<tr>
									<th style="font-size: 18px; font-weight: 600; text-align: center;" colspan="2">Pago y Envío</th>
								</tr>
								<tr>
									<td>--</td>
									<td>--</td>
								...
								<tr>
									<th style="font-size: 18px; font-weight: 600; text-align: center;" colspan="2">Facruración</th>
								</tr>
								<tr>
									<td>--</td>
									<td>--</td>
					...
					<div id="Extras" class="tabcontent-estilo2">
						...
						<div style="overflow-x: auto;">
							<table class="table" style="text-align: center;">
								...
								<tr>
									<th style="font-size: 18px; font-weight: 600; text-align: center;" colspan="2">Productos/Servicios</th>
								</tr>
								<tr>
									<td style="width:50%;">Cada 100 productos con opciones sencillas 1 a 100</td>
									<td style="width:50%;">$500 c/u</td>
								</tr>
								<tr>
									<td style="width:50%;">Cada 100 productos con opciones avanzadas</td>
									<td style="width:50%;">$1,000</td>
								</tr>
								<tr>
									<th style="font-size: 18px; font-weight: 600; text-align: center;" colspan="2">Traducciones (cada 250 palabras)</th>
								</tr>
								<tr>
									<td style="width:50%;">Ingles</td>
									<td style="width:50%;">$500</td>
								</tr>
								<tr>
									<td style="width:50%;">Francés</td>
									<td style="width:50%;">$500</td>
								</tr>
								<tr>
									<td style="width:50%;">Alemán</td>
									<td style="width:50%;">$500</td>
								</tr>
								<tr>
									<td style="width:50%;">Mandarín</td>
									<td style="width:50%;">$1,000</td>
								</tr>
								<tr>
									<td style="width:50%;">101 a 500</td>
									<td style="width:50%;">$450 c/u</td>
								</tr>
								<tr>
									<td style="width:50%;">500 a 1000</td>
									<td style="width:50%;">$400 c/u</td>
								</tr>
								<tr>
									<td style="width:50%;">1000+</td>
									<td style="width:50%;">$350 c/u</td>
								</tr>
								</tbody>
							</table>
						</div> 
  						...
  						<div class="fila" style="align-items: center;">
					    	...
					    	<div class="column-12 column-m-6">
					    		...
					    		<ul class="slider__ul">
						    		...
						    		<li class="slider__li">Document Gantt del proyecto</li>
						    	</ul>
					    	</div>
					    </div>
					</div>
		...
		<div class="contenido">
			...
			<div class="fila" style="align-items: center;">
				<div class="column-4 column-m-4">
					<a href="http://mobiliere.com.mx/" target="_blank"><img class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/logo-mobiliere.svg"></a>
				</div>
				<div class="column-4 column-m-4">
					<a href="https://ginettecain.com/" target="_blank"><img class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/logo-gc-animated.gif"></a>
				</div>
				<div class="column-4 column-m-4">
					<a href="https://popalott.com/" target="_blank"><img class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/popalott-logo.png"></a>
				</div>
				<div class="column-4 column-m-4">
					<a href="https://brightce.com/" target="_blank"><img class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/bce 1.png"></a>
				</div>
				<div class="column-4 column-m-4">
					<a href="https://jarestaurantservices.com/" target="_blank"><img class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/jars-templogo.png"></a>
				</div>
				<div class="column-4 column-m-4">
					<a href="http://ludi.com.mx/" target="_blank"><img class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/logo-ludi.png"></a>
				</div>
				<div class="column-4 column-m-4">
					<a href="https://portafoliodenegocios.com.mx/" target="_blank"><img class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/pdn-logo.png"></a>
				</div>
				<div class="column-4 column-m-4">
					<a href="https://www.txtint.com/" target="_blank"><img class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/tx-tint-logo.png"></a>
				</div>
				<div class="column-4 column-m-4">
					<a href="https://ajbabogados.com/" target="_blank"><img style="background-color: #222; padding: 10px;" class="imagen imagen-centrada testimonios__body--imagen" src="images/logos/logo-light.png"></a>
				</div>
			</div>
		</div>
	</section>
