...
<head>
	...
	<!-- SEO página Home -->
	<title>ITedup | Sitios Web Autoadministrables, Blogs y Revistas</title>
			...
			<div class="fila">
				<div class="column-12 column-m-12" style="padding-right: 0; padding-left: 0;">
					<div class="headerPage__contenido">
						...
						<h1 class="molecula-titulo-principal color-secundario headerPage__contenido--titulo">Sitios Web Autoadministrables, Blogs y Revistas</h1>
						<h2 class="molecula-subtitulo color-secundarioA headerPage__contenido--subtitulo">Obtén un sitio web que tú mismo puedas administrar usuarios y crear y editar páginas y publicaciones.</h2>
					      	...
					      	<div class="swiper-slide">
						      	<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$7,500</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$4,500</h4>
									</div>
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$11,500</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$7,500</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$17,000</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$12,000</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$23,000</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$17,000</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$30,000</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$22,000</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
					      	...
					      	<div class="swiper-slide">
					      		<div class="tarjeta s-paquetes__tarjeta">
									<div class="tarjeta-header s-paquetes__tarjeta-header">
										...
										<span class="s-paquetes__tarjeta-header--descuento color-secundario">$42,000</span>
										<h4 class="s-paquetes__tarjeta-header--precio color-secundario">$32,000</h4>
									</div>
									<div class="tarjeta-body s-paquetes__tarjeta-body">
										<ul class="s-paquetes__tarjeta-lista">
